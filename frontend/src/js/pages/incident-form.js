...
export function buildTabsHTML(tabContainerStyle = '', opts = {}) {
  ...
  return `
    <div class="incident-tabs" style="display:flex;gap:2px;background:#f4f5f7;border-bottom:1px solid #e2e8f0;overflow-x:auto;${tabContainerStyle}">
      ${visibleTabs.map(t => `
        <button class="incident-tab" data-tab="${t.idx}"
          style="padding:10px 16px;background:none;border:none;border-bottom:2px solid transparent;
                 color:#64748b;cursor:pointer;font-size:13px;white-space:nowrap;font-weight:400">
          ${t.label}
        </button>`).join('')}
    </div>
    ${buildPanelsHTML()}
...
function buildPanelsHTML() {
  return `
    ...
    <div class="incident-tab-panel" data-panel="2" style="display:none;padding:20px 0">
      <h4 style="margin:0 0 12px;font-size:13px;color:#64748b;text-transform:uppercase;letter-spacing:.05em">Kräftestärke (eigene)</h4>
      ...
      <h4 style="margin:0 0 12px;font-size:13px;color:#64748b;text-transform:uppercase;letter-spacing:.05em">Personenschäden</h4>
      <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-bottom:24px">
        ${[
      ...
      <h4 style="margin:0 0 12px;font-size:13px;color:#64748b;text-transform:uppercase;letter-spacing:.05em">Tierschäden</h4>
      ...
      <h4 style="margin:0 0 12px;font-size:13px;color:#64748b;text-transform:uppercase;letter-spacing:.05em">Sachschäden</h4>
    ...
    return `
      <div class="form-group">
        <label style="font-size:12px">${esc(r.label)}
          <span style="color:#64748b">(${r.unit})</span></label>
